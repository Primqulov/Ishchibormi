...
// Ranglar apps/web/tailwind.config.ts dan AYNAN ko'chirilgan (Figma
// "Ishchi Bormi — Web Dizayn"). Mini App sayt bilan bir xil ko'rinishi kerak,
// shuning uchun bu qiymatlar mustaqil "tanlanmaydi" — sayt o'zgarsa, bu fayl
// ham o'sha manbadan yangilanadi.
const config: Config = {
  darkMode: "class",
